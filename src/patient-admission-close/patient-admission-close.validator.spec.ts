...
describe('PatientAdmissionCloseValidator',()=>{
  ...
  const valid=()=>({clientId:1,tariffId:2,patient:{name:'Paciente',age:30,ageUnit:'Años',sex:false,sample:'Tomada aquí'},exams:[{examCatalogId:7}],payments:[{typePaymentId:1,amount:10,currency:'BASE' as const,fieldValues:[]}]});

...
@Module({ imports: [AuthorizationModule, TypeOrmModule.forFeature([Grouphtitems, Groupht, Examlists])], controllers: [GroupHtItemsController], providers: [GroupHtItemsService] })
